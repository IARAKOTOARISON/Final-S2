        ...
        <div class="row mt-5">
            <div class="col-5">
                ...
                <div class="list-group mb-4">
                    ...
                    foreach ($liste as $l) { ?>
                        <a href="modele2.php?idobj=<?= $l['id_objet'] ?>" class="list-group-item list-group-item-action"><?= $l['nom_objet'] ?>

                            <?php $imm = get_image($l['id_objet']);
                            if ($imm != 0) { ?>
                                <img src="../inc/uploads/<?= $imm['nom_image'] ?>" style="width:100px" alt="image de l obj" srcset="">
                            <?php } if ($imm == 0)  { ?>
